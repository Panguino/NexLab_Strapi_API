...
export interface ApiCampusCampus extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    uniqueWeatherConditions: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCampusweatherLinkCampusweatherLink
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    LinkGroup: Schema.Attribute.Component<'list.group', true> &
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    MaterialGroup: Schema.Attribute.Component<'list.material-group', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDegreeDegree extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Schools: Schema.Attribute.Component<'list.schools', true>;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFaqOverviewFaqOverview extends Struct.SingleTypeSchema {
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Group: Schema.Attribute.Component<'list.group', true> &
      Schema.Attribute.SetMinMax<
        {
          max: 4;
          min: 4;
...
export interface ApiStormChasingMaterialsPageStormChasingMaterialsPage
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    leftGroupMaterials: Schema.Attribute.Component<'list.material-group', true>;
    leftGroupTitle: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rightGroupMaterials: Schema.Attribute.Component<
      'list.material-group',
      true
    >;
    rightGroupTitle: Schema.Attribute.String;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
